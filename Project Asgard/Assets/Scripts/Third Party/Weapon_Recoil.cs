/*
 taken from https://www.youtube.com/watch?v=ADcDHxPBJ4g&list=PLqi_nbtwjfeo9uZ7PC5ZupOB2ir3YLUmQ&index=5&t=392s
 */
...
public class Weapon_Recoil : MonoBehaviour
{
    ...
    // adding method to reset rotation output to 0 when not fireing
    public void Reset()
    {
        RotationOutput = Vector3.zero;
    }
}